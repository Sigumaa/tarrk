...
class Settings(BaseSettings):
    ...
    default_max_rounds: int = Field(default=80, ge=1)
    min_rounds_before_conclusion: int = Field(default=12, ge=1)
    min_rounds_before_repetition_stop: int = Field(default=18, ge=1)
